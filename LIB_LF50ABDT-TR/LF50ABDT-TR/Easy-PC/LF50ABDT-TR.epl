...
(library Library_1
	...
	(compDef "LF50ABDT-TR" (originalName "LF50ABDT-TR") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "GROUND_(TAB)") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.st.com/web/en/resource/technical/document/datasheet/CD00000546.pdf")
		(attr "Height" "2.4 mm")
	)
